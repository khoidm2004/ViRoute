...
import RegisterSuccessNotify from '../notification/noti-reg.jsx';
  ...
  return (
    <body>
      <div className='register-page'>
        <img className='logo-login' src='./images/ViRoute_green.png' onClick={() => navigate('/')} />
        ...
        {showNotification && <RegisterSuccessNotify />}
